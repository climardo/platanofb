---
title: 2020 Week 5 Results
year: 2020
week: 5
layout: post
author: climardo
header_image: /assets/images/2020/week-5-header.jpg
header_pos: 50% 50%
---
{%- for item in site.data.weekly2020 -%}
    ...
    {%- endif -%}
{%- endfor -%}
Congratulations **rogdiaz** for snatching another win in consecutive weeks with an even smaller margin of 0.8 fpts! Sorry and congrats to **XplicitK** for placing second, you *just* missed it. 
...
Next week's contest is still in question. Thanks to rescheduling of games, DraftKings has not made the typical Thu - Mon contest available. We may have to do Sunday only, but I am definitely not creating the currently available contest of Tue (today) - Sun. That's just not enough notice. I will keep in touch with you all by SMS as I've done this season. Thanks all for another week.
