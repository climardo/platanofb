# About this project
This project is leveraging [GitHub Pages](https://pages.github.com/) to host a website used for managing announcement and posting results of a daily fantasy football league. 
